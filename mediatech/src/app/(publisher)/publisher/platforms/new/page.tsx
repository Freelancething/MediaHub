...
export default async function NewPlatformPage() {
  ...
  // Server action to save the platform
  ...
  return (
    <div style={{ maxWidth: '600px', margin: '0 auto' }}>
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold font-space text-dark mt-2">Add website platform</h1>
      </div>
      ...
      <div className="card bg-card border-base rounded-lg p-6">
        <form action={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <div>
            ...
            <input name="url" type="url" required placeholder="https://example.com" className="input" />
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
            <div>
              ...
              <input name="language" type="text" required defaultValue="English" className="input" />
            </div>
            <div>
              <label className="text-sm font-medium text-dark block mb-2 font-inter">Domain Authority (DA)</label>
              <input name="da" type="number" min="0" max="100" placeholder="30" className="input" />
            </div>
          </div>

          <div>
            <label className="text-sm font-medium text-dark block mb-2 font-inter">Monthly Organic Traffic</label>
            <input name="traffic" type="number" min="0" placeholder="5000" className="input" />
          </div>
          ...
          <div style={{ borderTop: '1px solid var(--color-border)', paddingTop: '16px', marginTop: '8px' }}>
            ...
            <div>
              ...
              <input name="price" type="number" step="0.01" min="1" required defaultValue="10.00" className="input" />
            </div>
          </div>
