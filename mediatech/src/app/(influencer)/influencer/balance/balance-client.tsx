  ...
  return (
    <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div className="p-6 border-t border-muted text-sm text-dark leading-relaxed font-inter">
          ...
          <div className="grid grid-cols-3 gap-6 mb-4">
            ...
            <div>
              ...
              <Link href="/influencer/balance?view=reserved" className="text-primary hover:underline block text-xs mt-1">Learn more</Link>
            </div>
            <div>
      ...
      <div className="flex justify-between items-center bg-[#81F5FF20] border border-[#81F5FF60] p-6 rounded-lg mb-6">
        ...
        <Link 
          href="/influencer/balance?action=request"
      ...
      <div className="grid grid-cols-3 gap-6 mb-8">
        <Link 
          href="/influencer/balance?view=main" 
        ...
        <Link 
          href="/influencer/balance?view=reserved" 
        ...
        <Link 
          href="/influencer/balance?view=bonus" 
